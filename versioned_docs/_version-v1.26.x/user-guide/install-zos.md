...
<figure>
  <image usemap="#home_map1" border="0" id="install-flow" src={require("/v1.26.x/images/common/zowe-zos-install-diagram.png").default} width="850" alt="Click each step to get more details on the flow." />
