...
<img src={require("/v1.23.x/images/ze/ZE-newProfiles.gif").default} width="600" alt="New Connection"/>
...
<img src={require("/v1.23.x/images/ze/ZE-prof-update.gif").default} width="600" height="300" alt="Edit a Profile"/>
...
<img src={require("/v1.23.x/images/ze/ZE-associate.gif").default} width="600" height="300" alt="Edit a Profile"/>
