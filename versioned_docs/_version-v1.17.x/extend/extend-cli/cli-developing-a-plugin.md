...
![Side by Side Diff](pathname:///v1.17.x/images/guides/CLI/htmlDiff.png)
...
![Pipe Output](pathname:///v1.17.x/images/guides/CLI/pipeOutput.png)

The raw diff output is displayed as a command response:

![Raw Diff Output](pathname:///v1.17.x/images/guides/CLI/diffOutput.png)
