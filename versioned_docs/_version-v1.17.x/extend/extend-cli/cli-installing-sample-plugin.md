...
![Installed](pathname:///v1.17.x/images/guides/CLI/InstalledSample.png "Installed Sample Plugin")

## Using the installed plug-in
To use the plug-in functionality, issue: `zowe zowe-cli-sample list directory-contents`:

![Output](pathname:///v1.17.x/images/guides/CLI/SampleOutput.png "Sample Plugin Output")
