...
<img src={require("/v1.17.x/images/ze/ZE-multiple-search.gif").default} alt="View Data Set"/>
...
<img src={require("/v1.17.x/images/ze/ZE-rename.gif").default} alt="Rename Data Set"/>
...
<img src={require("/v1.17.x/images/ze/ZE-copy.gif").default} alt="Copy Data Set"/>
...
<img src={require("/v1.17.x/images/ze/ZE-download-edit.gif").default} alt="Edit"/>
...
<img src={require("/v1.17.x/images/ze/ZE-save.gif").default} alt="Save"/>
...
<img src={require("/v1.17.x/images/ze/ZE-cre-pds-member.gif").default} alt="Create"/>
...
<img src={require("/v1.17.x/images/ze/ZE-del-pds-member.gif").default} alt="Delete"/>
...
<img src={require("/v1.17.x/images/ze/ZE-mult-profiles.gif").default} alt="Add Profile"/>
...
<img src={require("/v1.17.x/images/ze/ZE-allocate-like.gif").default} alt="Allocate Like"/>
...
5. From the drop-down, enter the path that you want as the root of your displayed tree.  
  ...
  **Note:** You will not be able to expand directories or files that you are not authorised for.
   ...
   <img src={require("/v1.17.x/images/ze/ZE-path.gif").default} alt="Enter Path"/>
...
<img src={require("/v1.17.x/images/ze/ZE-refreshUSS.gif").default} alt="Refresh All"/>
...
<img src={require("/v1.17.x/images/ze/ZE-editUSS.gif").default} alt="Edit"/>
...
<img src={require("/v1.17.x/images/ze/ZE-CreateDelete.gif").default} alt="Create and Delete"/>
...
<img src={require("/v1.17.x/images/ze/ZE-profile2.gif").default} alt="View Profiles"/>
...
<img src={require("/v1.17.x/images/ze/ZE-jobs-get-jcl.gif").default} alt="View JOB"/>
...
<img src={require("/v1.17.x/images/ze/ZE-jobs-download-spool.gif").default} alt="Download Spool"/>
...
<img src={require("/v1.17.x/images/ze/ZE-Jobs-Issue-TSO-Command.gif").default} alt="Issue a MVS command"/>
