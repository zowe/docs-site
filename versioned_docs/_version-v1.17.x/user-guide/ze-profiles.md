...
<img src={require("/v1.17.x/images/ze/ZE-newProfiles.gif").default} width="600" alt="New Connection"/>
...
<img src={require("/v1.17.x/images/ze/ZE-edit-ze-profile.gif").default} width="600" height="300" alt="Edit a Profile"/>
...
<img src={require("/v1.17.x/images/ze/ZE-profile-links.gif").default} width="600" height="300" alt="Edit a Profile"/>
