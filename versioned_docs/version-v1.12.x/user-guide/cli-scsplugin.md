...
- <a href="/v1.12.x/web_help/index.html" target="_blank">Browse Online</a>
- <a href="/v1.12.x/zowe_web_help.zip" target="_blank">Download (ZIP)</a>
- <a href="/v1.12.x/CLIReference_Zowe.pdf" target="_blank">Download (PDF)</a>
...
When you uninstall the plug-in, existing profiles become invalid and you must recreate them. For more information, see [Create CLI Profiles](cli-configuringcli#creating-zowe-cli-profiles.md).
