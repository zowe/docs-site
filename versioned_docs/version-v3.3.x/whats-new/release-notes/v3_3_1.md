...
* Fixed the AT-TLS filter in single-service deployment (modulith) mode and Ltpa2 token.  ([#4285](https://github.com/zowe/api-layer/issues/4285))
...
* The property `apiml.gateway.servicesToDisableRetry` was introduced to single-service deployment mode (modulith). ([#4307](https://github.com/zowe/api-layer/issues/4307))
...
* Updated the modulith version of the z/OSMF static definition. ([#4333](https://github.com/zowe/api-layer/issues/4333))
