...
Zowe&trade; uses the SPDX SBOM format to represent its bill of materials. To read more about why SBOMs and SPDX are used, see [this blog](https://www.linuxfoundation.org/blog/spdx-its-already-in-use-for-global-software-bill-of-materials-sbom-and-supply-chain-security/). The hash codes can be used to validate your download is authentic using a command like `openssl dgst -sha1 <downloaded_sbom.zip>`. 
