...
2. Click the tile to view header information, the registered services under that family ID,
 and API documentation for that service.
   ...
   **Example:**
   ...
   <img src="pathname:///v1.27.x/images/api-mediation/newswagger.png" alt="controller detail" width="500px"/>

3. Select the version (**v1**, **v2**) to view the documentation of a specific API version.

    **Example:**

    <img src="pathname:///v1.27.x/images/api-mediation/discoverableclient-apiv1.png" alt="discoverable client api v1" width="500"/>

    <img src="pathname:///v1.27.x/images/api-mediation/discoverableclient-apiv2.png" alt="discoverable client api v2" width="500"/>
...
4. Expand the endpoint panel to see a detailed summary with responses and parameters of each endpoint,
 the endpoint description, and the full structure of the endpoint.
   ...
   **Example:**
   ...
   <img src="pathname:///v1.27.x/images/api-mediation/expanded.png" alt="endpoint detail" width="500px"/>
...
- **Protected endpoints** 
  ...
  Endpoints that are only accessible by entering user credentials. These endpoints are marked with a lock icon.
    ...
    **Example:**
    ...
    <img src="pathname:///v1.27.x/images/api-mediation/catalog_proctected_endpoints_swagger_lock.png" alt="endpoint detail" width="1000px"/>
    ...
    **Example:**
    ...
    <img src="pathname:///v1.27.x/images/api-mediation/catalog_proctected_endpoints_swagger_auth.png" alt="endpoint detail" width="300px"/>

To demonstrate **Try it out**, we use the example of the Swagger Petstore.

**Example:**

<img src="pathname:///v1.27.x/images/api-mediation/discoverable_clien_pet_swagger.png" alt="endpoint detail" width="700px"/>
...
2. Click **Try it out**.
   ...
   **Example:**
    ...
    <img src="pathname:///v1.27.x/images/api-mediation/discoverable_clien_pet_swagger_expanded.png" alt="endpoint detail" width="700px"/>
...
4. Click **Execute**.
   ...
   **Example:**
    ...
    <img src="pathname:///v1.27.x/images/api-mediation/discoverable_clien_pet_swagger_execute.png" alt="endpoint detail" width="700px"/>
   ...
   **Example:**
    ...
    <img src="pathname:///v1.27.x/images/api-mediation/discoverable_clien_pet_swagger_response.png" alt="endpoint detail" width="700px"/>
...
<img src="pathname:///v1.27.x/images/api-mediation/api_refresh_button.png" alt="api refresh" width="700px"/>
...
<img src="pathname:///v1.27.x/images/api-mediation/api_refresh_success.png" alt="api refresh success" width="700px"/>
...
<img src="pathname:///v1.27.x/images/api-mediation/api_refresh_error.png" alt="api refresh error" width="700px"/>
