...
<img src={require("/v2.3.x/images/ze/ZE-copy-member.gif").default} alt="Copy Data Set Member"/>
...
<img src={require("/v2.3.x/images/ze/ZE-CreateDelete.gif").default} alt="Create and Delete"/>
