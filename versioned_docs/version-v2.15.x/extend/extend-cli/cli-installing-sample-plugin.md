...
## Overview
This tutorial covers installing and running this bundled Zowe&trade; CLI plugin as-is (without modification), which adds a command to the CLI that lists the contents of a directory on your computer.
