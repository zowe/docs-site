...
- Introduced the "SJ" feature to the JES Explorer application ([#282](https://github.com/zowe/zlux/issues/282))
  ...
  <img src={require("/v1.16.x/images/releasenotes/v17-sjdemo.gif").default} alt="SJ Demo" width="550px"/>
...
- The <a href="/v1.16.x/CLIReference_Zowe.pdf" target="_blank">CLI Reference Guide</a> is featured on the Zowe Docs home page. The document is a comprehensive guide to commands and options in Zowe CLI.
