...
- **Docs: Zowe CLI command reference guide**
   ...
   - <b><a href="/v1.22.x/CLIReference_Zowe.pdf" target="_blank">Download CLI reference in PDF format</a></b>
   - <b><a href="/v1.22.x/zowe_web_help.zip" target="_blank">Download CLI reference in ZIP format</a></b>
