...
![Zowe Architecture Diagram](pathname:///v1.22.x/images/common/zowe-architecture.png)
...
![Zowe Architecture Diagram with High Availability Enablement](pathname:///v1.22.x/images/common/zowe-architecture-ha.png)
...
![Zowe Architecture Diagram using Docker](pathname:///v1.22.x/images/common/zowe-architecture-docker.png)
...
![Zowe Desktop Diagram](pathname:///v1.22.x/images/mvd/zowe-desktop.png)
...
![Zowe API Mediation Layer](pathname:///v1.22.x/images/api-mediation/api-mediationlayer.png)
...
![Zowe API Catalog](pathname:///v1.22.x/images/api-mediation/api-catalog.png)
...
![Zowe API Discovery](pathname:///v1.22.x/images/api-mediation/api-discovery.png)
...
![Zowe Desktop Explorers](pathname:///v1.22.x/images/mvd/desktop-explorers.png)
