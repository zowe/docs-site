...
![Zowe Architecture Diagram](/v1.22.x/images/common/zowe-architecture.png)
...
![Zowe Architecture Diagram with High Availability Enablement](/v1.22.x/images/common/zowe-architecture-ha.png)
...
![Zowe Architecture Diagram using Docker](/v1.22.x/images/common/zowe-architecture-docker.png)
...
![Zowe Desktop Diagram](/v1.22.x/images/mvd/zowe-desktop.png)
...
![Zowe API Mediation Layer](/v1.22.x/images/api-mediation/api-mediationlayer.png)
...
![Zowe API Catalog](/v1.22.x/images/api-mediation/api-catalog.png)
...
![Zowe API Discovery](/v1.22.x/images/api-mediation/api-discovery.png)
...
![Zowe Desktop Explorers](/v1.22.x/images/mvd/desktop-explorers.png)
