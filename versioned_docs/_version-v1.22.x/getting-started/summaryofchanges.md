...
You can now explore the Zowe CLI command help in an interactive online format. See <a href="/v2.0.x/web_help/index.html" target="_blank">Zowe CLI Web Help</a>.
...
- The <a href="/v2.0.x/CLIReference_Zowe.pdf" target="_blank">CLI Reference Guide</a> is featured on the Zowe Docs home page. The document is a comprehensive guide to commands and options in Zowe CLI.
