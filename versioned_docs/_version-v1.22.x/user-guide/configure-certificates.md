...
<img src={require("/v1.22.x/images/common/zowe-ssl.png").default} alt="Zowe SSL" width="700px"/> 
...
<img src={require("/v1.22.x/images/common/zowe-directories-keys.png").default} alt="Zowe Directories" width="700"/> 
