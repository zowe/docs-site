...
![Issuing the help command](pathname:///v1.22.x/images/guides/CLI/GetHelp.gif)
...
- <a href="/v1.22.x/web_help/index.html" target="_blank">Browse Online</a>
- <a href="/v1.22.x/zowe_web_help.zip" target="_blank">Download (ZIP)</a>
- <a href="/v1.22.x/CLIReference_Zowe.pdf" target="_blank">Download (PDF)</a>
...
![jenkins gui](pathname:///v1.22.x/images/guides/CLI/envVarsJenkins.png)
