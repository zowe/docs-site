...
<img src="pathname:///v1.19.x/images/api-mediation/apiml-startup.png" alt="Zowe API Mediation Layer Startup" width="600px"/> 

When all services are fully initialized, there will be three green ticks.

<img src="pathname:///v1.19.x/images/api-mediation/apiml-started.png" alt="Zowe API Mediation Layer Startup" width="300px"/> 
