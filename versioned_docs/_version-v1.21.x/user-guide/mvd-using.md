...
<img src="pathname:///v1.21.x/images/mvd/personalization.png" />
...
To refresh the data on any tab, click ![the circular arrow](pathname:///v1.21.x/images/mvd/mvd_workflow2.png) in the upper right corner of the window.
...
When you click **CHECK** or **PERFORM**, a work area on the right side of the window opens to display the steps to complete the task. Expand or collapse the work area by clicking  ![alt text](pathname:///v1.21.x/images/mvd/mvd_workflow3.png).
...
To manage a task in the PERFORM status, click ![alt text](pathname:///v1.21.x/images/mvd/mvd_workflow1.png) to the right of the task status. Choose from the following options:
