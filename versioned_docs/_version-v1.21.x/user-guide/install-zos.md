...
<figure>
  <image usemap="#home_map1" border="0" id="install-flow" src="pathname:///v1.21.x/images/common/zowe-zos-install-diagram.png" width="850" alt="Click each step to get more details on the flow." />
