...
![Side by Side Diff](/v1.21.x/images/guides/CLI/htmlDiff.png)
...
![Pipe Output](/v1.21.x/images/guides/CLI/pipeOutput.png)

The raw diff output is displayed as a command response:

![Raw Diff Output](/v1.21.x/images/guides/CLI/diffOutput.png)
