...
![Zowe CICS Explorer profiles from config](/v2.6.x/images/ze-cics/create-profile-from-config.gif)
...
![Zowe CICS Explorer profiles](/v2.6.x/images/ze-cics/create-profile.gif)
...
![Zowe CICS Explorer update profiles from config](/v2.6.x/images/ze-cics/update-profile-from-config.gif)
...
3. Once the details are updated, click the **Update Profile** button to apply the changes to the profile.
   ...
   ![Zowe CICS Explorer update profiles](/v2.6.x/images/ze-cics/update-profile.gif)
...
3. To unhide the profile, click the **+** button and select the profile from the quick pick list.
   ...
   ![Zowe CICS Explorer hide profiles](/v2.6.x/images/ze-cics/hide-profile.gif)
...
![Zowe CICS Explorer delete profiles from config](/v2.6.x/images/ze-cics/delete-profile-from-config.gif)
...
![Zowe CICS Explorer delete profiles](/v2.6.x/images/ze-cics/delete-profile.gif)
