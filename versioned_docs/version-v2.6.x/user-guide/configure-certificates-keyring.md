...
<<<<<<<< HEAD:versioned_docs/version-v2.0.x/user-guide/configure-certificates-keyring.md
...
>>>>>>>> master:versioned_docs/version-v2.6.x/user-guide/configure-certificates-keyring.md
