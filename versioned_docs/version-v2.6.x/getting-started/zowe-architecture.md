...
![Zowe Architecture Diagram](/v2.6.x/images/common/zowe-architecture.png)
...
![Zowe Architecture Diagram with High Availability Enablement](/v2.6.x/images/common/zowe-architecture-lpar.png)
...
![Zowe Architecture Diagram in Kubernetes](/v2.6.x/images/common/zowe-architecture-k8s.png)
...
![Zowe Desktop Diagram](/v2.6.x/images/mvd/zowe-desktop.png)
...
![Zowe API Mediation Layer](/v2.6.x/images/api-mediation/api-mediationlayer.png)
...
![Zowe API Catalog](/v2.6.x/images/api-mediation/api-catalog.png)
...
![Zowe API Discovery](/v2.6.x/images/api-mediation/api-discovery.png)
...
![Zowe Desktop Explorers](/v2.6.x/images/mvd/desktop-explorers.png)
