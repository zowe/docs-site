...
![Zowe Architecture Diagram](pathname:///v2.6.x/images/common/zowe-architecture.png)
...
![Zowe Architecture Diagram with High Availability Enablement](pathname:///v2.6.x/images/common/zowe-architecture-lpar.png)
...
![Zowe Architecture Diagram in Kubernetes](pathname:///v2.6.x/images/common/zowe-architecture-k8s.png)
...
![Zowe Desktop Diagram](pathname:///v2.6.x/images/mvd/zowe-desktop.png)
...
![Zowe API Mediation Layer](pathname:///v2.6.x/images/api-mediation/api-mediationlayer.png)
...
![Zowe API Catalog](pathname:///v2.6.x/images/api-mediation/api-catalog.png)
...
![Zowe API Discovery](pathname:///v2.6.x/images/api-mediation/api-discovery.png)
...
![Zowe Desktop Explorers](pathname:///v2.6.x/images/mvd/desktop-explorers.png)
