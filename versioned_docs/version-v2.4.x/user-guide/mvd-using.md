...
<img src={require("/v2.4.x/images/mvd/person.png").default}/>

### Changing user password
 
1. Open the Preferences panel by clicking on the Preferences icon in the bottom right of the desktop.

<img src={require("/v2.4.x/images/mvd/settings.png").default}/>
...
<img src={require("/v2.4.x/images/mvd/personalization.png").default}/>
