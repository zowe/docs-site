...
1.  Click your username at the top of the navigation panel and click **Invite People**.
    ...
    ![Invite people](pathname:///v2.4.x/images/zowe-chat/mattermost_invite_people.png "Invite people")
...
2.  In the **Invite members to BnzDev** field, search your bot user and select it, then click **Invite** to invite the bot to this team.
    ...
    ![Add or invite people](pathname:///v2.4.x/images/zowe-chat/mattermost_add.png "Add or invite people")

3.  Click **Done**.

    ![Members invited](pathname:///v2.4.x/images/zowe-chat/mattermost_invited.png "Members invited")
