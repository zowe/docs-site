...
* You may encounter an issue that some plugins are not showing up in Zowe Desktop. You can click the `Refresh Applicationsicon ` button in the Desktop start menu.
