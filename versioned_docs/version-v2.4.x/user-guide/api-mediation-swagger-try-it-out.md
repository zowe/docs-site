...
- **Protected endpoints** 
  ...
  Endpoints that are only accessible by entering user credentials. These endpoints are marked with a lock icon.
    ...
    **Example:**
    ...
    <img src={require("/v2.4.x/images/api-mediation/catalog_proctected_endpoints_swagger_lock.png").default} alt="endpoint detail" width="1000px"/>
    ...
    **Example:**
    ...
    <img src={require("/v2.4.x/images/api-mediation/catalog_proctected_endpoints_swagger_auth.png").default} alt="endpoint detail" width="300px"/>

To demonstrate **Try it out**, we use the example of the Swagger Petstore.

**Example:**

<img src={require("/v2.4.x/images/api-mediation/discoverable_clien_pet_swagger.png").default} alt="endpoint detail" width="700px"/>
...
2. Click **Try it out**.
   ...
   **Example:**
    ...
    <img src={require("/v2.4.x/images/api-mediation/discoverable_clien_pet_swagger_expanded.png").default} alt="endpoint detail" width="700px"/>
...
4. Click **Execute**.
   ...
   **Example:**
    ...
    <img src={require("/v2.4.x/images/api-mediation/discoverable_clien_pet_swagger_execute.png").default} alt="endpoint detail" width="700px"/>
   ...
   **Example:**
    ...
    <img src={require("/v2.4.x/images/api-mediation/discoverable_clien_pet_swagger_response.png").default} alt="endpoint detail" width="700px"/>