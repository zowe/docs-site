...
![Configure IntelliJ z/OSMF connection](pathname:///v2.4.x/images/intellij/intellij-configure.gif)
...
![Configure IntelliJ files working set](pathname:///v2.4.x/images/intellij/intellij-files-working-set.gif)
...
![Configure IntelliJ JES working set](pathname:///v2.4.x/images/intellij/intellij-jes-working-set.gif)
