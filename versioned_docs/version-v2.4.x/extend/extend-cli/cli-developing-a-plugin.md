...
![Side by Side Diff](/v2.4.x/images/guides/CLI/htmlDiff.png)
...
![Pipe Output](/v2.4.x/images/guides/CLI/pipeOutput.png)

The raw diff output is displayed as a command response:

![Raw Diff Output](/v2.4.x/images/guides/CLI/diffOutput.png)
