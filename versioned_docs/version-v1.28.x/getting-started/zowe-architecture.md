...
![Zowe Architecture Diagram](/v1.28.x/images/common/zowe-architecture.png)
...
![Zowe Architecture Diagram with High Availability Enablement](/v1.28.x/images/common/zowe-architecture-lpar.png)
...
![Zowe Architecture Diagram in Kubernetes](/v1.28.x/images/common/zowe-architecture-k8s.png)
...
![Zowe Architecture Diagram using Docker](/v1.28.x/images/common/zowe-architecture-docker.png)
...
![Zowe Desktop Diagram](/v1.28.x/images/mvd/zowe-desktop.png)
...
![Zowe API Mediation Layer](/v1.28.x/images/api-mediation/api-mediationlayer.png)
...
![Zowe API Catalog](/v1.28.x/images/api-mediation/api-catalog.png)
...
![Zowe API Discovery](/v1.28.x/images/api-mediation/api-discovery.png)
...
![Zowe Desktop Explorers](/v1.28.x/images/mvd/desktop-explorers.png)
