...
<img src={require("/v1.28.x/images/api-mediation/safidt-providers.png").default} alt="SAF IDT providers"/>

The following diagram illustrates how communication using the SAF IDT provider works:

<img src={require("/v1.28.x/images/api-mediation/safidt-diagram.png").default} alt="SAF IDT diagram"/>
