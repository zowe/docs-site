...
<img src={require("/v2.5.x/images/api-mediation/catalog-pass-expired-warn.png").default} alt="api refresh error" width="700px"/>
...
<img src={require("/v2.5.x/images/api-mediation/catalog-new-pass-err.png").default} alt="api refresh error" width="700px"/>
...
<img src={require("/v2.5.x/images/api-mediation/catalog-pass-update-ok.png").default} alt="api refresh error" width="700px"/>
