...
- **Docs: Zowe CLI command reference guide**
   ...
   - <b><a href="/2.5.x/web_help/index.html" target="_blank">Browse online</a></b>
   - <b><a href="/2.5.x/CLIReference_Zowe.pdf" target="_blank">Download CLI reference in PDF format</a></b>
   - <b><a href="/2.5.x/zowe_web_help.zip" target="_blank">Download CLI reference in ZIP format</a></b>
