...
* When a JWT is provided, the API Gateway validates the Zowe JWT, generates a PassTicket from the JWT, and passes the PassTicket to the downstream service. The downstream service then validates the PassTicket.
