...
Use the following procedure to enable the zowe.yaml file to use a client certificate as a method of authentication for the API Mediation Layer Gateway.
