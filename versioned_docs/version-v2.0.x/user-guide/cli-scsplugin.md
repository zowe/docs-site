...
- <a href="/v2.0.x/zowe_web_help.zip" target="_blank">Download (ZIP)</a>
- <a href="/v2.0.x/CLIReference_Zowe.pdf" target="_blank">Download (PDF)</a>
...
When you uninstall the plug-in, existing profiles become invalid and you must recreate them. For more information, see [Using profiles](cli-using-using-profiles.md).
