...
### ZSS
- Added a module registry to improve how modules are tracked and managed, making extension handling more consistent and easier to maintain. ([#732](https://github.com/zowe/zss/pull/732))

### Basic TN3270 Display Emulator
- Added a configurable Backspace key capability that users can use to choose between moving the cursor only (default) or deleting characters, configurable via the configuration file or GUI. 
([#100](https://github.com/zowe/tn3270-ng2/pull/100))
