...
<img src={require("/v1.18.x/images/common/zowe-architecture.png").default} alt="Zowe Architecture Diagram" width="700px"/> 
...
<img src={require("/v1.18.x/images/common/zowe-architecture-docker.png").default} alt="Zowe Architecture Diagram using Docker" width="700px"/> 
...
<img src={require("/v1.18.x/images/mvd/zowe-desktop.png").default} alt="Zowe Desktop Diagram" width="600px"/> 
...
<img src={require("/v1.18.x/images/api-mediation/api-mediationlayer.png").default} alt="Zowe API Mediation Layer" width="600px"/> 
...
<img src={require("/v1.18.x/images/api-mediation/api-catalog.png").default} alt="Zowe API Catalog" width="600px"/> 
...
<img src={require("/v1.18.x/images/api-mediation/api-discovery.png").default} alt="Zowe API Discovery" width="600px"/> 
...
<img src={require("/v1.18.x/images/mvd/desktop-explorers.png").default} alt="Zowe Desktop Explorers" width="600px"/> 
