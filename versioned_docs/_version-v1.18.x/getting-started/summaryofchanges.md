...
<!-- #### Zowe Explorer -->
<!--Pulled from https://github.com/zowe/zowe-explorer-vscode/blob/master/packages/zowe-explorer/CHANGELOG.md, no changes since 1.11.0.-->
...
- The <a href="/v1.18.x/CLIReference_Zowe.pdf" target="_blank">CLI Reference Guide</a> is featured on the Zowe Docs home page. The document is a comprehensive guide to commands and options in Zowe CLI.
