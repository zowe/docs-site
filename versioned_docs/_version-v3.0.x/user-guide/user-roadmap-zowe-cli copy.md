...
- [**Zowe CLI overview**](../getting-started/overview.md#zowe-cli)
   ...
   New to Zowe CLI? This overview topic provides an introduction to Zowe CLI.
...
- [**Zowe CLI FAQs**](../getting-started/zowe_faq.md#zowe-cli-faq)
   ...
   If you have a question, check out the FAQ, which answers the most commonly asked questions about Zowe CLI.
...
- **Docs: Zowe CLI command reference guide**
   ...
   View detailed documentation on commands, actions, and options in Zowe CLI. The reference document is based on the `@zowe-v3-lts` version of the CLI.
   ...
   - <b><a href="/v3.0.x/web_help/index.html" target="_blank">Browse online</a></b>
   - <b><a href="/v3.0.x/CLIReference_Zowe.pdf" target="_blank">Download CLI reference in PDF format</a></b>
   - <b><a href="/v3.0.x/zowe_web_help.zip" target="_blank">Download CLI reference in ZIP format</a></b>
