...
<img src={require("/v1.20.x/images/api-mediation/zowe-client-cert-auth.png").default} alt="Zowe client certificate authentication diagram" align="center" width="700px"/>
