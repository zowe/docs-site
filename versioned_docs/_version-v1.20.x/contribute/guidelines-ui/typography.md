...
![type sample](/v1.20.x/images/extender/type_sample.png)
...
- Font-weight: 300 / Light
  ...
  ![type light sample](/v1.20.x/images/extender/type_light_sample.png)

  Should only be used at sizes greater than or equal to 18px / 1.125rem

- Font-weight: 400 / Normal

  ![type regular sample](/v1.20.x/images/extender/type_regular_sample.png)

- Font-weight: 500 / Semi-bold

  ![type bold sample](/v1.20.x/images/extender/type_bold_sample.png)
...
- 1.333 Perfect Fourth-type scale - desktop
  ...
  ![type desktop sample](/v1.20.x/images/extender/type_scale_desktop-1024x533.png)

- 1.2 Minor Third type-scale - mobile

  ![type mobile sample](/v1.20.x/images/extender/type_scale_mobile-1024x461.png)
