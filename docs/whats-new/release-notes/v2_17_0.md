...
### Zowe Launcher
- Component list generation now uses `configmgr` instead of `zwe`, providing a more consistent, configuration-driven way to determine which components are included at runtime. ([#117](https://github.com/zowe/launcher/pull/117))
...
#### Zowe Common C
- Fixed an issue where configmgr did not return an error when the last configuration file was nonexistent or contained errors, improving error detection during startup. ([#460](https://github.com/zowe/zowe-common-c/pull/460))
