...
### Zowe Launcher
- Syslog output is now limited to 512 bytes per line. Any characters beyond that limit are truncated, helping keep log records within the expected syslog size. ([#103](https://github.com/zowe/launcher/pull/103))
- Component list generation now uses `configmgr` instead of `zwe`, providing a more consistent, configuration-driven way to determine which components are included at runtime. ([#103](https://github.com/zowe/launcher/pull/103))
- At startup, Zowe Launcher prints an initial check message that indicates whether your log lines are long enough to remain readable when shared with support personnel, helping you spot truncated diagnostic output early. ([#101](https://github.com/zowe/launcher/pull/101))
...
- See the [Zowe Explorer](https://github.com/zowe/zowe-explorer-vscode/blob/v2-lts/packages/zowe-explorer/CHANGELOG.md) changelog for updates included in this release.

#### Zowe Explorer API

- See the [Zowe Explorer API](https://github.com/zowe/zowe-explorer-vscode/blob/v2-lts/packages/zowe-explorer-api/CHANGELOG.md) changelog for updates included in this release.

####  Zowe Explorer for IBM z/OS FTP

- See the [Zowe® Explorer for IBM® z/OS® FTP](https://github.com/zowe/zowe-explorer-vscode/blob/v2-lts/packages/zowe-explorer-ftp-extension/CHANGELOG.md) changelog for updates included in this release.

#### Zowe Explorer ESLint Plug-in

- See the [Zowe Explorer ESLint Plug-in](https://github.com/zowe/zowe-explorer-vscode/blob/v2-lts/packages/eslint-plugin-zowe-explorer/CHANGELOG.md) changelog for updates included in this release.
...
### Zowe Launcher
- Log timestamps now use UTC instead of local time, so Zowe Launcher output matches server timestamps more consistently and is easier to correlate during troubleshooting. ([#103](https://github.com/zowe/launcher/pull/103))
- Syslog entries no longer include the server timestamp in the message body, preventing duplicate time values and making logs cleaner and easier to parse. ([#103](https://github.com/zowe/launcher/pull/103))
