...
* If no `zowe.logDirectory` is defined in config, logging is disabled. ([#317](https://github.com/zowe/zlux-app-server/pull/317))
...
#### Zowe Installer
- The `zwe init` command does not require NodeJS. ([#4088](https://github.com/zowe/zowe-install-packaging/pull/4088))
