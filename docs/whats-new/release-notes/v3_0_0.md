...
* Added a new plugin identifier to the list of plugins and `allowedPlugins.json` for the new V3 Desktop in Angular 18. ([#3984](https://github.com/zowe/zowe-install-packaging/pull/3984)) 
...
* Updated all webpack configurations across zlux-app-manager apps (virtual-desktop, bootstrap, app-prop-viewer, web-browser-app, system-settings-preferences) from version 4 to 5, including updated loaders, modules, and dependencies. The legacy Webpack 4 configuration remains available for backward compatibility. ([#550](https://github.com/zowe/zlux-app-manager/pull/550))
...
- TN3270 now correctly identifies and communicates additional CCSIDs (037, 273, 275, 277, 278, 280, 284, 285, 297, 424, 437, 500, 870, 871, 875, 924, 1025, 1047, 1140–1148) instead of always defaulting to CCSID 37. ([#95](https://github.com/zowe/tn3270-ng2/pull/95))
...
- [Zowe® Explorer for IBM® CICS® Transaction Server](https://github.com/zowe/cics-for-zowe-client/blob/main/packages/vsce/CHANGELOG.md)
- [Zowe® Explorer for IBM® z/OS® FTP](https://github.com/zowe/zowe-explorer-vscode/blob/main/packages/zowe-explorer-ftp-extension/CHANGELOG.md)
