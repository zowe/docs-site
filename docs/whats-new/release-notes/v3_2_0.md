...
* Changed error code SERVICE_UNAVAILABLE to INTERNAL_SERVER_ERROR when ticket generation fails in Zowe v3. ([#4047](https://github.com/zowe/api-layer/issues/4047))
