...
- Added an enhancement to compress the Zowe v3 Desktop assets so that the Desktop can load faster on a slow internet connection and slow network speed. (#658)
