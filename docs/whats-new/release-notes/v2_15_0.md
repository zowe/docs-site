...
- Added flags to avoid linkage-stack queries in the recovery facility, preventing potential issues in system configurations. ([#412](https://github.com/zowe/zowe-common-c/pull/412))
