...
#### zlux-server-framework
- Fixed an issue where the proxy did not properly handle errors; it returned a `500 Internal Server` as an error message. (https://github.com/zowe/zlux-server-framework/pull/487)
