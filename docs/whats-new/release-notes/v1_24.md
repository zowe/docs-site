...
* Support of node.js `v14.17.2` is excluded due to encoding issues we noticed. Please check [System requirements](../../user-guide/systemrequirements-zos#zos-system-requirements)
