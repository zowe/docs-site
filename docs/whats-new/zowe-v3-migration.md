...
- **Java**  
Java 17 is required. Java 21 and Java 25 are also supported. The Zowe YAML parameter `java.home` value should be a **Java 17** (or **Java 21** or **Java 25**) home location. If an administrator uses `zwe init` to set up Zowe, ensure the `java` for that user is v17 (or newer) by including it in the `PATH` environment variable.
- **Node.js**  
