...
5.  Have experience in working with the Zoe App framework
6.  Become familiar with one of the Zoe App widgets: the grid widget

So, let's get started!

1.  [Constructing an App Skeleton](#constructing-an-app-skeleton)
    - [Defining your first Plugin](#defining-your-first-plugin)
...
2.  [Building your First Dataservice](#building-your-first-dataservice)
...
3.  [Adding your First Widget](#adding-your-first-widget)
    - [Adding your Dataservice to the App](#adding-your-dataservice-to-the-app)
    - [Introducing ZLUX Grid](#introducing-zlux-grid)
4.  [Adding Zoe App-to-App Communication](#adding-zoe-app-to-app-communication)
    - [Calling back to the Starter App](#calling-back-to-the-starter-app)

## Constructing an App Skeleton

If you look within the example repository, you'll see that a few boilerplate files already exist to help you get your first App running quickly. The structure of this repository follows the guidelines for Zoe App filesystem layout.
...
When the server runs, it will check for these sorts of files in its `pluginsDir`. In our case, this is `/zlux-example-server/deploy/instance/ZLUX/plugins/`.
...
An App can have one or more Dataservices. A Dataservice is a REST or Websocket endpoint that can be added to the Zoe App Server.
