...
Take a look at the [Creating a RestAPI with Swagger documentation using Liberty](libertyAPI.html) tutorial for the background to the Restful API with Swagger documentation we will be using.
