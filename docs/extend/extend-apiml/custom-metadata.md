...
* **customMetadata.apiml.gateway.applyRateLimiterFilter**  
  When this parameter is set to `true`, the rate limiter is be applied to the request for this service. When enabling this filter, you can also define the following properties:
