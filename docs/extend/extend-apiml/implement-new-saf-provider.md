...
<img src="pathname:///stable/images/api-mediation/safidt-providers.png" alt="SAF IDT providers"/>

The following diagram illustrates how communication using the SAF IDT provider works:

<img src="pathname:///stable/images/api-mediation/safidt-diagram.png" alt="SAF IDT diagram"/>
