...
**Note:** To streamline the process of onboarding new REST API services to the Zowe API Mediation Layer, see [Onboarding a REST API service with teh YAML Wizard](onboard-wizard/#onboarding-your-rest-service-with-the-wizard.md)
