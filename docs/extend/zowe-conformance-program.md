...
The Zowe conformance criteria is available in the [Zowe Conformance Test Evaluation Guide](https://github.com/openmainframeproject/zowe-conformance/blob/main/docs/test_evaluation_guide_table.md) in the Open Mainframe Project's GitHub repo. If you find a mistake with the Zowe conformance documents, or you are a Zowe squad lead and want to make an amendment to the criteria, you can open a Pull Request to ammend this file.
