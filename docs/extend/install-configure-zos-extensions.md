...
**Note:** The `zowe-upgrade-component.sh` script is still an alpha release feature, and it could bring compatibility issues between the upgraded components and the other Zowe components.
