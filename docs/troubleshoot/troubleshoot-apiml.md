...
The Zowe started task needs to run under the user with sufficient privileges. As a workaround you can try running it under the same user ID as z/OSMF (typically IZUSVR).
