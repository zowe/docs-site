...
The Zowe Application Framework uses GitHub issues.  Check whether is an already a GitHub issue (open or closed) that covers the problem, see [https://github.com/zowe/zlux/issues](https://github.com/zowe/zlux/issues).
