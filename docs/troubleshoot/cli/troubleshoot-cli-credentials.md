...
If you are running Zowe CLI in a CI/CD pipeline or another non-interactive environment on macOS, use environment variables to supply credentials instead of the secure credential store. For more information, see [Using environment variables](../../user-guide/cli-using-using-environment-variables.md).
