...
- Node.js version 6.14.4.1 or later *on the z/OS host* where you install the Zowe Application Server. Node.js version 8 is not currently supported. To install Node.js on z/OS, follow the instructions in [Installing Node.js on z/OS](install-nodejs-zos.md).
