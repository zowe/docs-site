...
1.	If you are running z/OS V2R2 and V2R3, download job IZUTSSEC and upload this Job to z/OS. If you are running z/OS V2R4, IZUTSSEC is located at SYS1.SAMPLIB.
2.	IZUTSSEC must be reviewed and edited before submit. You can review the IZUTSSEC section below for more details.
3.	Submit IZUNUSEC as a batch job on your z/OS system.  
