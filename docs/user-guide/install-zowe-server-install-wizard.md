...
:::note
The Zpwe Server Install Wizard is currently available only as a technical preview. This preview includes some of the installation options. Future releases will include more options with validation and discovery properties that can assist with Zowe server installation.
...
:::tip
To review open issues, ask questions, find solutions, and report bugs, see [Zen Issues](https://github.com/zowe/zen/issues)
:::
