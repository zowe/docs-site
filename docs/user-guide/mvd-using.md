...
<img src={require("/stable/images/mvd/person.png").default}/>

### Changing user password
 
1. Open the Preferences panel by clicking on the Preferences icon in the bottom right of the desktop.

<img src={require("/stable/images/mvd/settings.png").default}/>
...
<img src={require("/stable/images/mvd/personalization.png").default}/>
