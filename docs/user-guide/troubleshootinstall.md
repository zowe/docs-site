...
The *command not found* message displays because Node.js and NPM is not installed on your PC. To correct this behavior, install Node.js and NPM and reissue the npm command to install Zowe CLI.
