...
| Configure certificates | **Option 1: Use zwe command group** <br />&nbsp;&nbsp;&nbsp;&nbsp;1. [Configure PKCS12 certificates](/docs/user-guide/configure-certificates-keystore.md) <br />&nbsp;&nbsp;&nbsp;&nbsp;2. [Configure JCERACFKS certificates in a key ring](/docs/user-guide/configure-certificates-keyring.md) <br />**Option 2: Use workflows** <br />&nbsp;&nbsp;&nbsp;&nbsp;1. [Set up Zowe certificates using workflows](/docs/user-guide/certificates-setup.md) | Add results |2 hours  |In-progress, <br />Complete 
| Configure HA (optional) | **Option 1: Use a Hot Backup**<br />(multiple instances are configured and ready, but a single instance handles the traffic)<br />**Option 2: Load Balancing** <br />(multiple instances are running, and all instances handle the traffic)| Add results |2 hours  |
