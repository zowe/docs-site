...
- The web UI facilitates common z/OS developer or system programmer tasks by providing an editor for common text-based files like REXX or JCL. The editor also provides general purpose data set actions for both Unix System Services (USS) and MVS data sets and Job Entry System (JES) logs.
