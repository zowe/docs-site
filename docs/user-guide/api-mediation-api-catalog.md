...
**Note:** For more information about how to configure the API Catalog in the application.yml, see: [Add API Onboarding Configuration](docs/extend/extend-apiml/onboard-a-spring-boot-rest-api-service.md).
