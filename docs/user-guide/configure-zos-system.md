...
## Step 1: User IDs and groups for the Zowe started tasks

<!--In progress-->

## Step 2: Configure the cross memory server for SAF
...
## Step 3: Configure an ICSF cryptographic services environment
...
## Step 4: Configure security environment switching
