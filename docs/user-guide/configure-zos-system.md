...
The `ZWESVSTC` started task is multiuser address space therefore a TSS FACILITY needs to be defined and assigned to the started task.
The all acids signing on to the started task will need to be authorized to the FACILITY.

Example how to create a new TSS FACILITY:
