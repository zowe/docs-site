...
Another option to prepare a JCL member to configure the z/OS system is to edit `ZWESECUR` directly.   

The JCL allows you to vary which security manager you use by setting the _PRODUCT_ variable to one of the following values:  
