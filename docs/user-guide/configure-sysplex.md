...
2. Define a dynamic VIPA (DVIPA) for both systems:
   ...
   - 7554 is the port number of you Zowe API Mediation Layer Gateway. This should be the same port number you configured for `zowe.externalPort` in `zowe.yaml`. Check [Reviewing the zowe.yaml file](configure-instance-directory.md#reviewing-the-zowe-yaml-file-technical-preview) to learn more about `zowe.yaml`.
