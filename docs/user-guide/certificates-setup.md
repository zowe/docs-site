...
3. Sign a CSR request using ZWESIGNC.xml
   ...
   **Note:** Ensure that the workflow includes a USS location of the CSR request and a USS location where a signed certificate is stored in pem format in the input.
