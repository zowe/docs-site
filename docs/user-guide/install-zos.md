...
For more information on the Zowe components and how they are used to launch an instance of Zowe see [Installation and Configuration](./installandconfig.md#planning-the-installation-of-zowe-z/os-components)
