...
1. Verify the integrity of the PAX file to ensure that the file you download is officially distributed by the Zowe project.
    ...
    **Step 2. Verify with signature file.**
      ...
      **Follow these steps:**
      ...
      1. Download the signature file `zowe-v.r.m.pax.asc` from [https://zowe.org/Downloads/post_download.html](https://projectgiza.org/Downloads/post_download.1.0.1.html), and download the public key `KEYS` from https://github.com/zowe/release-management/.
