...
![Configure IntelliJ files working set](pathname:///stable/images/intellij/create_files_working_set.gif)
...
![Configure IntelliJ JES working set](pathname:///stable/images/intellij/create_jes_working_set.gif)
