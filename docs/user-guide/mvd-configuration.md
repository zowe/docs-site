...
Plug-ins can also have dataservices that control their [configuration](../extend/extend-desktop/mvd-configdataservice.md#configuration-dataservice). These dataservices have scope at the product, site, instance, and user level, and the data is stored and retrieved by path name.
