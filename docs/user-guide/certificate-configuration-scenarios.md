...
* contains the _Extended Key Usage_ section and also includes the "Server" and "Client" authentication fields.
* does not contain the _Extended Key Usage_ section at all.
...
* [Scenario 5: Use a z/OS keyring-based keystore and import a certificate stored in a data set](#scenario-5-use-a-zos-keyring-based-and-import-a-certificate-stored-in-a-data-set)

[blah](#scenario-5-use-a-zos-keyring-based-keystore-and-import-a-certificate-stored-in-a-data-set)
