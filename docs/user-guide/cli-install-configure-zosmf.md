...
Before you start the configuration process, review [Overview of z/OSMF](https://www.ibm.com/docs/en/zos/3.2.0?topic=zosmf-overview) in the IBM Documentation.
