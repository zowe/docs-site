...
When CORS handling is enabled, the Gateway automatically intercepts and answers preflight (`OPTIONS`) requests on behalf of the service, replying with the following default CORS response headers:
