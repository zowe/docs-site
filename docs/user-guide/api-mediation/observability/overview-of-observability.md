...
Observability can be enabled and configured using API ML and OpenTelemetry settings in the zowe.yaml file to control which data is produced and where it is exported.