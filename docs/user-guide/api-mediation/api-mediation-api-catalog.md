...
**Note:** For more information about how to configure the API Catalog in the application.yml, see: [Add API Onboarding Configuration](topics/api-mediation/api-mediation-onboard-an-existing-sprint-boot-rest-api-service.md).
