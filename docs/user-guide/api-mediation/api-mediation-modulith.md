...
This **single-service deployment mode** (also known as "Modulith mode") alternative to the multi-service scheme brings the following performance benefits and simplification in configuration for new installations:
