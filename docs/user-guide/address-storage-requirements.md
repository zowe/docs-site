...
* [Memory Allocation Recommendation](../user-guide/install-zowe-pswi-deployment.md#memory-allocation-recommendation) in the article _Installing Product Software Using z/OSMF Deployments_ in Zowe Docs
