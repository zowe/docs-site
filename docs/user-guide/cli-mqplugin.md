...
IBM MQ Plug-in for Zowe CLI lets users issue MQSC commands to a queue manager. MQSC commands let you to perform administration tasks. For example, you can define, alter, or delete a local queue object.
