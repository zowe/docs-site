...
- **apiml.gateway.servicesToDisableRetry**
 Specifies a comma-separated list of service IDs for which automatic retries are disabled, helps prevent potential memory issues when handling requests with large payloads. This parameter applies to Zowe version 3.3.0 and later versions. 
