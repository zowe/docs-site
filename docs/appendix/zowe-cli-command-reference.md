...
- <a href="/v2.18.x/CLIReference_Zowe.pdf" target="_blank">Download CLI reference in PDF format</a>
- <a href="/v2.18.x/zowe_web_help.zip" target="_blank">Download CLI reference in ZIP format</a>
