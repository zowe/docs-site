...
[zwe](.././zwe.md) > [validate](./zwe-validate.md)

	zwe validate [sub-command [sub-command]...] [parameter [parameter]...]

## Sub-commands

* [config](./zwe-validate-config.md)
* [port](./port/zwe-validate-port.md)
