...
The external documentation for the Zowe project, [Zowe Docs](https://zowe.github.io/docs-site/latest/), is completely open-source. See [How to contribute](../contributing.md) for more information about contributing to the documentation.
