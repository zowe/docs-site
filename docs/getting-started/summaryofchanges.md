...
- The [CLI Reference Guide](https://docs.zowe.org/stable/CLIReference_Zowe.pdf) is featured on the Zowe Docs home page. The document is a comprehensive guide to commands and options in Zowe CLI. 
