...
For details about multi-factor authentication, see [the MFA documentation here](https://docs.zowe.org/stable/user-guide/mvd-configuration/#multi-factor-authentication-configuration).
