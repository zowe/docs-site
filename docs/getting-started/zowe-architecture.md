...
![Zowe Architecture Diagram](pathname:///stable/images/common/zowe-architecture.png)
...
![Zowe Architecture Diagram with High Availability Enablement](pathname:///stable/images/common/zowe-architecture-lpar.png)
...
![Zowe Architecture Diagram in Kubernetes](pathname:///stable/images/common/zowe-architecture-k8s.png)
...
![Zowe Desktop Diagram](pathname:///stable/images/mvd/zowe-desktop.png)
...
![Zowe API Mediation Layer](pathname:///stable/images/api-mediation/api-mediationlayer.png)
...
![Zowe API Catalog](pathname:///stable/images/api-mediation/api-catalog.png)
...
![Zowe API Discovery](pathname:///stable/images/api-mediation/api-discovery.png)
...
![Zowe Desktop Explorers](pathname:///stable/images/mvd/desktop-explorers.png)
