...
![Zowe Architecture Diagram](/stable/images/common/zowe-architecture.png)
...
![Zowe Architecture Diagram with High Availability Enablement](/stable/images/common/zowe-architecture-lpar.png)
...
![Zowe Architecture Diagram in Kubernetes](/stable/images/common/zowe-architecture-k8s.png)
...
![Zowe Desktop Diagram](/stable/images/mvd/zowe-desktop.png)
...
![Zowe API Mediation Layer](/stable/images/api-mediation/api-mediationlayer.png)
...
![Zowe API Catalog](/stable/images/api-mediation/api-catalog.png)
...
![Zowe API Discovery](/stable/images/api-mediation/api-discovery.png)
...
![Zowe Desktop Explorers](/stable/images/mvd/desktop-explorers.png)
