...
Check out the [Enabling Secure Credential Store page](https://docs.zowe.org/stable/user-guide/ze-profiles.html#enabling-secure-credential-store-with-zowe-explorer) to see how to use the Zowe Explorer securely.

</details>

### How can I use FTP as my backend service for Zowe Explorer?
