...
* Add trivial schema files for lib components. Update manifests to remove build metadata (#2379) ([6eba58f](https://github.com/zowe/api-layer/commit/6eba58f)), closes [#2379](https://github.com/zowe/api-layer/issues/2379)
* Extend API operation filter in the Swagger UI (#2397) ([cffd6cf](https://github.com/zowe/api-layer/commit/cffd6cf)), closes [#2397](https://github.com/zowe/api-layer/issues/2397)
...
<!-- V2 CHANGELOGS
https://github.com/zowe/zlux-app-server/blob/v2.x/staging/CHANGELOG.md  | No v2.1.0 entry.
https://github.com/zowe/zss/blob/v2.x/staging/CHANGELOG.md  | No v2.1.0 entry.
https://github.com/zowe/zlux-editor/blob/v2.x/staging/CHANGELOG.md  | Not sure what the versions number there means
https://github.com/zowe/zowe-common-c/blob/v2.x/staging/CHANGELOG.md  | No v2.x entries
https://github.com/zowe/tn3270-ng2/blob/v2.x/staging/CHANGELOG.md  | No v2.x entries, Not sure what the versions number there means
https://github.com/zowe/vt-ng2/blob/v2.x/staging/CHANGELOG.md  | No v2.x entries, Not sure what the versions number there means
https://github.com/zowe/zlux-app-manager/blob/v2.x/staging/CHANGELOG.md   | No v2.x entries
https://github.com/zowe/zlux-server-framework/blob/v2.x/staging/CHANGELOG.md  | No v2.x entries
--> 
...
| need to understand, what versions to pull -->
...
which versions are the ones that should be included? 2.0.1 and later, should 2.0.0-next.xxx be included? This will remain manual process. 
-->
...
<!--  https://github.com/zowe/vscode-extension-for-zowe/blob/master/packages/zowe-explorer/CHANGELOG.md 
which versions are the ones that should be included? 2.0.1 and later, should 2.0.0-next.xxx be included? The folloiwng ones only included 2.0.1 to 2.0.3. -->
