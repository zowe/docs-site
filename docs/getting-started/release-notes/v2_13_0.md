...
- For Zowe V3, deprecated `getDataSet` in the `zosfiles` command group utility functions. In Zowe V3, use `zosfiles` SDK's `ZosFilesUtils.getDataSetFromName` command instead. ([#1696](https://github.com/zowe/zowe-cli/issues/1696))
