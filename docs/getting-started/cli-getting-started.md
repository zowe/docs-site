...
The following command installs the IBM CICS, Db2, FTP, IMS, and MQ plug-ins:

```
zowe plugins install @zowe/cics-for-zowe-cli @zowe/db2-for-zowe-cli @zowe/ftp-for-zowe-cli @zowe/ims-for-zowe-cli @zowe/mq-for-zowe-cli
```
