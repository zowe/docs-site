...
Follow the best practices outlined in this article if you have performed a Zowe server-side upgrade but wish to downgrade to a previous version of Zowe.
