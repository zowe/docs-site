//Swizzled this component to override fallback for non-existent version links
...
export default function DocsVersionDropdownNavbarItem({
  ...
  const versionLinks = versions.map((version) => {
    ...
    const versionDoc =
      ...
      (activeDocContext?.activeDoc ? { path: `${version.path}/${activeDocContext.activeDoc.id}` } : getVersionMainDoc(version));
    return {
      label: version.label,
