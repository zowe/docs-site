...
const data = [
  ...
  },
  {
    ...
    description: <>Find out how to install and configure Zowe. Learn about how to use Zowe components, including Zowe Application Framework, API Mediation Layer, and Zowe CLI.</>,
  },
  {
    title: 'Extending',
    lightIcon: 'img/question-solid.svg',
      ...
      <Link to={useBaseUrl(link)}>
        <div className={clsx("card margin-bottom--lg", styles.card)}>
          <div className="card__header">
            ...
            <img src={imgLightIconUrl} alt="icons" style={{ width: '16px' }} className={clsx(styles.lightThemeIcon)} />
            <img src={imgDarkIconUrl} alt="icons" style={{ width: '16px' }} className={clsx(styles.darkThemeIcon)}/>
          <h3>{title}</h3>
          </div>
...
function Features() {
  return (
    <>
      {data && data.length > 0 && (
        <section id="features" className={clsx(styles.features)} style={{ padding: '4rem 0'}}>
