...
module.exports = {
  ...
  themeConfig: {
      ...
      content:
          '📌 • <b>Support for Zowe Version 2 ends on March 30, 2027</b>. Follow <a href="https://docs.zowe.org/stable/whats-new/zowe-v3-migration/" target="_blank">this guide</a> to migrate to Zowe Version 3.<br />' +
        '• The last v3 release (v3.8) is scheduled for March 1, 2027.',
      textColor: '#000',
      },
    docs: {
      sidebar: {
